...
public class HotelReservation {
	public static void findBestRatedHotel(ArrayList<Hotel> hotelList) {
		...
		Hotel hotel = hotelList.stream().max(Comparator.comparing(Hotel::getWeekDayRate)).get();
		int TotalRate = (int) (hotel.getWeekDayRate() * noOfDaysBetween);
		System.out.println("The best rated Hotel name is " + hotel.getName()+" And it's rating is "+hotel.getRating());
